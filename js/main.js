require([], function (){
    ...
    var loadMobile = function(){
        require([config.root+'js/mobile.js'], function(mobile){
            mobile.init();
            isMobileInit = true;
        });
    }
    var isPCInit = false;
    var loadPC = function(){
        require([config.root+'js/pc.js'], function(pc){
            pc.init();
            isPCInit = true;
        });
    }
    ...
    if(yiliaConfig.fancybox === true){
        require([config.root+'fancybox/jquery.fancybox.js'], function(pc){
            var isFancy = $(".isFancy");
            if(isFancy.length != 0){
    ...
    if(yiliaConfig.animate === true){
        ...
        require([config.root+'js/jquery.lazyload.js'], function(){
            //avatar
